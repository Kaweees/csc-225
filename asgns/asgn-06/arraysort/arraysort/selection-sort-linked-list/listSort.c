...
void swapNodes(struct Node** head_ref, struct Node* currX, struct Node* currY,
    struct Node* prevY);
...
studentNode studentArr[SIZE] = {{"Dougy", 13, 2122, NULL},
    {"Timmy", 15, 2122, NULL}, {"Emily", 18, 2123, NULL},
    {"Jimmy", 14, 2120, NULL}, {"Kimmy", 11, 2123, NULL},
    {"Carlo", 19, 2123, NULL}, {"Vicky", 22, 2120, NULL},
    {"Anton", 12, 2322, NULL}, {"Brady", 10, 2120, NULL},
    {"Sonya", 16, 2123, NULL}};
...
/* swapping nodes in a singly linked list is a pain. You need to swap the nodes
 * themselves, and the references to those nodes. */
void swapNodes(struct Node** head_ref, struct Node* currX, struct Node* currY,
    struct Node* prevY) {
  studentNode* temp;
