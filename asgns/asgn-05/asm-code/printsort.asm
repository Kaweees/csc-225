...
inner_loop:
	...
	blt t0, t4, if # if string[j] < smallest, goto if
	beq t0, t4, elif # if string[j] == smallest, goto if
	j end_if # goto end_if
if:
	bge t5, t0 end_if # if string[j] >= minCeiling, goto else
	li, t3, 1 # smallCount = 1
