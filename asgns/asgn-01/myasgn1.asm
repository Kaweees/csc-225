...
.data
Name: .string "Miguel Villa Floran" # Your name in double quotes
...
CarryNoOV1:	.word	1  # Replace DDD with a decimal value.
CarryNoOV2:	.word	3  # Replace DDD with a decimal value.
...
SignNoCarry1:	.word	-1 # Replace DDD with a decimal value.
SignNoCarry2:	.word	0  # Replace DDD with a decimal value.
